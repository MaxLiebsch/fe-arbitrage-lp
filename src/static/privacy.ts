import { Privacy } from '../types/Legal'
  ...
  sections: [
    ...
    },
    {
      ...
      subSections: [
        ...
        },
        {
          ...
          paragraphs: [
            'ofern Sie in die Datenverarbeitung eingewilligt haben, verarbeiten wir Ihre personenbezogenen Daten auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO bzw. Art. 9 Abs. 2 lit. a DSGVO, sofern besondere Datenkategorien nach Art. 9 Abs. 1 DSGVO verarbeitet werden. Im Falle einer ausdrücklichen Einwilligung in die Übertragung personenbezogener Daten in Drittstaaten erfolgt die Datenverarbeitung außerdem auf Grundlage von Art. 49 Abs. 1 lit. a DSGVO. Sofern Sie in die Speicherung von Cookies oder in den Zugriff auf Informationen in Ihr Endgerät (z. B. via Device-Fingerprinting) eingewilligt haben, erfolgt die Datenverarbeitung zusätzlich auf Grundlage von § 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten zur Vertragserfüllung oder zur Durchführung vorvertraglicher Maßnahmen erforderlich, verarbeiten wir Ihre Daten auf Grundlage des Art. 6 Abs. 1 lit. b DSGVO. Des Weiteren verarbeiten wir Ihre Daten, sofern diese zur Erfüllung einer rechtlichen Verpflichtung erforderlich sind auf Grundlage von Art. 6 Abs. 1 lit. c DSGVO. Die Datenverarbeitung kann ferner auf Grundlage unseres berechtigten Interesses nach Art. 6 Abs. 1 lit. f DSGVO erfolgen. Über die jeweils im Einzelfall einschlägigen Rechtsgrundlagen wird in den folgenden Absätzen dieser Datenschutzerklärung informiert.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Viele Datenverarbeitungsvorgänge sind nur mit Ihrer ausdrücklichen Einwilligung möglich. Sie können eine bereits erteilte Einwilligung jederzeit widerrufen. Die Rechtmäßigkeit der bis zum Widerruf erfolgten Datenverarbeitung bleibt vom Widerruf unberührt.f',
          ],
        },
        {
          title:
    ...
    },
    {
      ...
      subSections: [
        ...
        {
          title: 'Anfrage per E-Mail oder Telefon ',
          paragraphs: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Wir setzen folgende Chatbots ein:',
            {
              title: 'Chatwoot',
              paragraphs: [
                'Anbieter ist die Chatwoot Inc.  50 Battery Pl, New York, NY 10280, USA (nachfolgend Chatwoot).',
                'Chatwoot dient vor allem der Kommunikation mit dem Kunde im Rahmen von Supportanfragen und verarbeitet im Rahmen der Interaktion mit Ihnen alle eingegebenen Daten sowie Log-Daten (Browser Endgerät, etc.) und Ihre IP-Adresse, Chatwoot nutzt künstliche neuronale Netze (künstliche Intelligenz), um die Eingaben der Nutzer auszuwerten und passende Antworten zu generieren. Ferner findet eine Analyse des Nutzerverhaltens statt.',
                '',
                'Die Datenschutzerklärung von Chatwoot finden Sie hier: https://www.chatwoot.com/privacy-policy.',
              ],
            },
          ],
        },
        {
          ...
          paragraphs: [
            'Sie müssen sich auf dieser Website registrieren, um das Angebot der Webseite zu nutzen. Die dazu eingegebenen Daten verwenden wir nur zum Zwecke der Nutzung des jeweiligen Angebotes oder Dienstes, für den Sie sich registriert haben. Die bei der Registrierung abgefragten Pflichtangaben müssen vollständig angegeben werden. Anderenfalls werden wir die Registrierung ablehnen.',
    ...
    {
      id: 5,
      title: 'Online-Marketing und Partnerprogramme',
      subSections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Anbieter ist die eBay Partner Network, Inc., Details entnehmen Sie der Datenschutzerklärung von Amazon unter: https://partnernetwork.ebay.com/page/network-agreement#privacy-notice.',
          ],
        },
      ],
    },
    {
      id: 6,
      title: 'eCommerce und Zahlungsanbieter',
      subSections: [
        {
                    ...
                    },
                    {
                      ...
                      paragraphs: [
                        'Wir haben Sentry auf dieser Website eingebunden. Anbieter ist die Functional Software Inc., 45 Fremont Street, 8th Floor, San Francisco, California 94105, USA (nachfolgend Sentry).',
                        {
                          ...
                          bullets: [
                            'IP Adresse',
                            'Browser und zugehörige Version',
                            'Betriebssystem',
                            'Timezone',
                            'devise Architecture',
                            'CPU',
