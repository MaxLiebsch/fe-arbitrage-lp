...
export const terms: Terms = {
  ...
  sections: [
    {
      id: 1,
      title: 'Allgemeine Bestimmungen und Leistungsgegenstand',
      paragraphs: [
        'Der Anbieter stellt seinen Kunden eine webbasierte Software (Software as a Service) einschließlich Wartung und Pflege nach Maßgabe dieser AGB zur Verfügung.',
        'Die vom Anbieter angebotenen Leistungen richten sich ausschließlich an Unternehmer im Sinne von § 14 BGB (natürliche oder juristische Person oder eine rechtsfähige Personengesellschaft, die bei Abschluss eines Rechtsgeschäfts in Ausübung ihrer gewerblichen oder selbständigen beruflichen Tätigkeit handelt) und an Freiberufler. Es werden keine Verträge mit Verbrauchern / Privatpersonen im Sinne des § 13 BGB geschlossen.',
    ...
    },
    {
      ...
      paragraphs: [
        'Der Anbieter stellt dem Kunden eine Software (nachfolgend „Software“) zur Verfügung, die dem Kunden den eigenen Sourcing Prozess abnimmt, indem sie dem Kunden Informationen zum Weiterverkauf von Produkten auf Verkaufsplattformen zur Verfügung stellt. Der Anbieter übernimmt für den Kunden den erforderlichen Rechercheprozess und ermöglicht ihm, auf der Basis der mittels der Software bereitgestellten Informationen eine eigene Verkaufsentscheidung zu treffen. Der Anbieter stellt keine auf die Produkte des Kunden zugeschnittenen, personalisierten Informationen zusammen, der Kunde wählt vielmehr die für ihn passenden Informationen selbst aus. Der Anbieter garantiert dem Kunden keine Gewinne und spricht keine Empfehlungen aus. ',
        'Im Übrigen richtet sich der aktuelle Funktionsumfang der Software nach der Leistungsbeschreibung im Angebot bzw. auf der Webseite. Vertragsgegenstand ist ausschließlich die Überlassung dieser Software zur Nutzung über das Internet und die Einräumung von Speicherplatz auf den Servern des Anbieters. Zum diesem Zweck richtet der Anbieter die Software auf einem Server ein, der über das Internet für den Kunden erreichbar ist.',
        ...
        'Der Anbieter erbringt die Leistungen unter Beachtung des jeweiligen Standes der Technik. Er entwickelt die Software laufend weiter und wird diese durch laufende Updates und Upgrades verbessern. Sofern zusätzliche Funktionalitäten angeboten werden, sind diese vorbehaltlich abweichender Vereinbarungen kostenpflichtig.',
    ...
    {
      id: 3,
      title: 'Registrierung, Vertragsschluss, Testphase',
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        'Der Anbieter räumt dem Kunden das nicht ausschließliche und nicht übertragbare Recht ein, die Software während der Dauer des Vertrages im Rahmen der SaaS-Dienste bestimmungsgemäß zu nutzen. Der Kunde darf die Software nur bearbeiten, soweit dies durch die bestimmungsgemäße Benutzung der Software laut jeweils aktueller Leistungsbeschreibung abgedeckt ist. Eine Vervielfältigung der Software ist nur zulässig, soweit dies durch die bestimmungsgemäße Benutzung der Software laut jeweils aktueller Leistungsbeschreibung abgedeckt ist. Zur notwendigen Vervielfältigung zählt das Laden der Software in den Arbeitsspeicher auf dem Server / Computer des Kunden, nicht jedoch die auch nur vorübergehende Installation oder das Speichern der Software auf Datenträgern (wie etwa Festplatten o.Ä.) der vom Kunden eingesetzten Hardware.',
        'Der Kunde ist nicht berechtigt, die Software oder den zur Verfügung gestellten Speicherplatz einem Dritten teilweise oder vollständig, entgeltlich oder unentgeltlich zur Nutzung zu überlassen. Eine Weitervermietung der Software ist dem Kunden ausdrücklich untersagt.',
      ],
    },
    {
      id: 5,
      title: 'Einräumung von Speicherplatz und Backups',
      paragraphs: [
        'Der Anbieter überlässt dem Kunden Speicherplatz auf einem Server zur Speicherung seiner Daten. Sofern der Speicherplatz begrenzt ist, wird dies dem Kunden bei Vertragsschluss mitgeteilt.',
        'Der Anbieter trägt dafür Sorge, dass die gespeicherten Daten über das Internet abrufbar sind. Er ist verpflichtet, geeignete Vorkehrungen gegen Datenverlust und zur Verhinderung unbefugten Zugriffs Dritter auf die Daten des Kunden zu treffen. Zu diesem Zweck wird der Anbieter regelmäßige Backups vornehmen sowie nach dem Stand der Technik Firewalls installieren.',
        'Der Kunde bleibt in jedem Fall Alleinberechtigter an den Daten und kann jederzeit die Herausgabe einzelner oder sämtlicher Daten verlangen. Dem Anbieter stehen hinsichtlich der Daten des Kunden weder ein Zurückbehaltungsrecht noch ein gesetzliches Vermieterpfandrecht (§ 562 BGB) zu.',
      ],
    },
    {
      id: 6,
      title: 'Support',
      paragraphs: [
        'Anwendungs- oder Softwareprobleme werden im Rahmen des Supports durch den Anbieter bearbeitet. Kunde steht hierfür jederzeit ein Chatbot zur Verfügung Darüber hinaus ist der Support ist grundsätzlich werktags von Montag bis Freitag 09:00 – 18:00 Uhr gewährleistet. Supportleistungen sind zum Zwecke der schnellstmöglichen Bearbeitung über die hierfür auf der Webseite des Anbieters vorgesehenen Kommunikationswege oder über das ggf. zur Verfügung stehende Ticket-System zu erfragen. Supportanfragen werden während der regulären Geschäftszeiten grundsätzlich chronologisch, nach der Reihenfolge ihres Eingangs beim Anbieter bearbeitet.',
      ],
    },
    {
      id: 7,
      title: 'Beeinträchtigung der Erreichbarkeit',
      paragraphs: [
    ...
    {
      id: 10,
      title: 'Sperrung und unzulässige Inhalte',
      paragraphs: [
    ...
    {
      id: 12,
      title: 'Haftung und Freistellung',
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        'Vorbehaltlich abweichender Bestimmungen hat der Vertrag je nach gewählter Variante eine Mindestlaufzeit von einem Monat oder einem Jahr und verlängert sich um die jeweilige Mindestlaufzeit, sofern er nicht vor Ablauf der Mindestlaufzeit oder jeder Verlängerung gekündigt wird. Die Kündigungsfrist beträgt bei Jahresabonnements einen Monat zum Ende der jeweiligen Laufzeit, bei Monatsabonnements eine Woche zum Ende der jeweiligen Laufzeit. Das Recht zur außerordentlichen fristlosen Kündigung aus wichtigem Grund bleibt unberührt. Zur fristlosen Kündigung ist der Anbieter insbesondere berechtigt, wenn der Kunde fällige Zahlungen trotz Mahnung und Nachfristsetzung nicht leistet oder die wesentlichen vertraglichen Bestimmungen über die Nutzung der Software vorsätzlich oder fahrlässig verletzt. ',
    ...
    {
      id: 14,
      title: 'Herausgabe und Löschung der Daten nach Vertragsbeendigung',
      paragraphs: [
    ...
    {
      id: 15,
      title: 'Vertraulichkeit und Geheimhaltung',
      paragraphs: [
        ...
        'Der Anbieter verpflichtet sich, mit allen von ihm im Zusammenhang mit der Vorbereitung, Durchführung und Erfüllung dieses Vertrages eingesetzten Mitarbeitern und Nachunternehmern eine mit vorstehendem Absatz inhaltsgleiche Regelung zu vereinbaren.',
      ],
    },
    {
      id: 16,
