    ...
    <>
      ...
      <main>
        <Container className="pt-4Z pb-16 lg:pt-32">
          ...
          <h3 className="mt-3 mb-2 font-display text-lg leading-7 text-slate-900">
            Allgemeine Hinweise
          </h3>{' '}
          <p>
          ...
          <p>
            ...
            Mutterkonzern X Corp., 1355 Market Street, Suite 900, San Francisco,
            CA 94103, USA. F&uuml;r die Datenverarbeitung von au&szlig;erhalb
            der USA lebenden Personen ist die Niederlassung Twitter
            International Unlimited Company, One Cumberland Place, Fenian
            Street, Dublin 2, D02 AX07, Irland, verantwortlich.
          </p>{' '}
          <p>
            ...
            von X (ehemals Twitter) und der Funktion &bdquo;Re-Tweet&ldquo; bzw.
            &bdquo;Repost&ldquo; werden die von Ihnen besuchten Websites mit
            Ihrem X (ehemals Twitter)-Account verkn&uuml;pft und anderen Nutzern
            bekannt gegeben. Wir weisen darauf hin, dass wir als Anbieter der
            Seiten keine Kenntnis vom Inhalt der &uuml;bermittelten Daten sowie
            deren Nutzung durch X (ehemals Twitter) erhalten. Weitere
            Informationen hierzu finden Sie in der Datenschutzerkl&auml;rung von
            X (ehemals Twitter) unter:{' '}
            <a
