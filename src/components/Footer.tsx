        ...
        {/* <div className="flex flex-col items-center border-t border-primary-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <Link href="#" className="group" aria-label="Arbispotter on X">
              <svg
                className="h-6 w-6 fill-primary-500 group-hover:fill-primary-700"
                aria-hidden="true"
                viewBox="0 0 24 24"
              >
            ...
            <Link href="#" className="group" aria-label="Arbispotter on GitHub">
              <svg
                className="h-6 w-6 fill-primary-500 group-hover:fill-primary-700"
                aria-hidden="true"
                viewBox="0 0 24 24"
          ...
          <p className="mt-6 text-sm text-primary-600 sm:mt-0">
